...
from nnunetv2.data_iterators import preprocessing_iterator_fromfiles
from nnunetv2.export_prediction import export_prediction_from_logits, \
    convert_predicted_logits_to_segmentation_with_correct_shape
from nnunetv2.sliding_window_prediction import compute_gaussian, \
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model(self, inference_model_dir: str) :
        """
        ...
        dataset_json = load_json(join(inference_model_dir, 'metadata/dataset.json'))
        plans = load_json(join(inference_model_dir, 'metadata/plans.json'))
        ...
        #     checkpoint = torch.load(join(inference_model_dir, f'checkpoint.pth'),
...
def main():
    ...
    parser.add_argument('-inf_dir_path', type=str, required=True,
    ...
    predictor.initialize_from_trained_model(
        args.inf_dir_path,
    )
